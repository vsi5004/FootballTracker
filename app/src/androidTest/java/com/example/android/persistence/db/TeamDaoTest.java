...
/**
 * Test the implementation of {@link TeamDao}
 */
...
public class TeamDaoTest {
    ...
    public void getProductsWhenNoProductInserted() throws InterruptedException {
        List<TeamEntity> products = LiveDataTestUtil.getValue(mTeamDao.loadAllTeams());
    ...
    public void getProductById() throws InterruptedException {
        ...
        TeamEntity product = LiveDataTestUtil.getValue(mTeamDao.loadProduct
